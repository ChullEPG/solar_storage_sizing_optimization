...
mon_fri_ls_1_25_perc_pen  = process_ev_schedule_data('data/3 scenarios data/2hrs_ls/2hr_ls_mixed_fleet_all_percentages/19/m-f/ls_pattern=0.txt')
mon_fri_ls_2_25_perc_pen = process_ev_schedule_data('data/3 scenarios data/2hrs_ls/2hr_ls_mixed_fleet_all_percentages/19/m-f/ls_pattern=1.txt')
mon_fri_ls_3_25_perc_pen  = process_ev_schedule_data('data/3 scenarios data/2hrs_ls/2hr_ls_mixed_fleet_all_percentages/19/m-f/ls_pattern=2.txt')
mon_fri_ls_4_25_perc_pen  = process_ev_schedule_data('data/3 scenarios data/2hrs_ls/2hr_ls_mixed_fleet_all_percentages/19/m-f/ls_pattern=3.txt')
...
annual_ls_2_25_perc_pen = pd.concat([pd.concat([weekly_ls_2_25_perc_pen] * 52, ignore_index=True), sat_ls_2_25_perc_pen], ignore_index=True)
annual_ls_3_25_perc_pen = pd.concat([pd.concat([weekly_ls_3_25_perc_pen] * 52, ignore_index=True), sat_ls_4_25_perc_pen], ignore_index=True)

# Downsample from minutely to hourly
annual_ls_1_25_perc_pen = downsample_minutely_to_hourly(annual_ls_1_25_perc_pen)
annual_ls_2_25_perc_pen = downsample_minutely_to_hourly(annual_ls_2_25_perc_pen)
annual_ls_3_25_perc_pen = downsample_minutely_to_hourly(annual_ls_3_25_perc_pen)
...
np.savetxt(f"processed_ev_schedule_data/25_perc/weekly_ls_2.txt", weekly_ls_2_25_perc_pen)
np.savetxt(f"processed_ev_schedule_data/25_perc/annual_ls_2.txt", annual_ls_2_25_perc_pen)

np.savetxt(f"processed_ev_schedule_data/25_perc/weekly_ls_3.txt", weekly_ls_3_25_perc_pen)
np.savetxt(f"processed_ev_schedule_data/25_perc/annual_ls_3.txt", annual_ls_3_25_perc_pen)
...
# Processing Weekly schedules (note- only taking first day of week for each of these so that can append them together in desired order)
mon_fri_ls_1_50_perc_pen  = process_ev_schedule_data('data/3 scenarios data/2hrs_ls/2hr_ls_mixed_fleet_all_percentages/38/m-f/ls_pattern=0.txt')
mon_fri_ls_2_50_perc_pen = process_ev_schedule_data('data/3 scenarios data/2hrs_ls/2hr_ls_mixed_fleet_all_percentages/38/m-f/ls_pattern=1.txt')
mon_fri_ls_3_50_perc_pen  = process_ev_schedule_data('data/3 scenarios data/2hrs_ls/2hr_ls_mixed_fleet_all_percentages/38/m-f/ls_pattern=2.txt')
mon_fri_ls_4_50_perc_pen  = process_ev_schedule_data('data/3 scenarios data/2hrs_ls/2hr_ls_mixed_fleet_all_percentages/38/m-f/ls_pattern=3.txt')
...
annual_ls_2_50_perc_pen = pd.concat([pd.concat([weekly_ls_2_50_perc_pen] * 52, ignore_index=True), sat_ls_2_50_perc_pen], ignore_index=True)
annual_ls_3_50_perc_pen = pd.concat([pd.concat([weekly_ls_3_50_perc_pen] * 52, ignore_index=True), sat_ls_4_50_perc_pen], ignore_index=True)

# Downsample from minutely to hourly
annual_ls_1_50_perc_pen = downsample_minutely_to_hourly(annual_ls_1_50_perc_pen)
annual_ls_2_50_perc_pen = downsample_minutely_to_hourly(annual_ls_2_50_perc_pen)
annual_ls_3_50_perc_pen = downsample_minutely_to_hourly(annual_ls_3_50_perc_pen)
...
np.savetxt(f"processed_ev_schedule_data/50_perc/weekly_ls_2.txt", weekly_ls_2_50_perc_pen)
np.savetxt(f"processed_ev_schedule_data/50_perc/annual_ls_2.txt", annual_ls_2_50_perc_pen)

np.savetxt(f"processed_ev_schedule_data/50_perc/weekly_ls_3.txt", weekly_ls_3_50_perc_pen)
np.savetxt(f"processed_ev_schedule_data/50_perc/annual_ls_3.txt", annual_ls_3_50_perc_pen)
...
# Processing Weekly schedules (note- only taking first day of week for each of these so that can append them together in desired order)
mon_fri_ls_1_75_perc_pen  = process_ev_schedule_data('data/3 scenarios data/2hrs_ls/2hr_ls_mixed_fleet_all_percentages/57/m-f/ls_pattern=0.txt')
mon_fri_ls_2_75_perc_pen = process_ev_schedule_data('data/3 scenarios data/2hrs_ls/2hr_ls_mixed_fleet_all_percentages/57/m-f/ls_pattern=1.txt')
mon_fri_ls_3_75_perc_pen  = process_ev_schedule_data('data/3 scenarios data/2hrs_ls/2hr_ls_mixed_fleet_all_percentages/57/m-f/ls_pattern=2.txt')
mon_fri_ls_4_75_perc_pen  = process_ev_schedule_data('data/3 scenarios data/2hrs_ls/2hr_ls_mixed_fleet_all_percentages/57/m-f/ls_pattern=3.txt')
...
annual_ls_2_75_perc_pen = pd.concat([pd.concat([weekly_ls_2_75_perc_pen] * 52, ignore_index=True), sat_ls_2_75_perc_pen], ignore_index=True)
annual_ls_3_75_perc_pen = pd.concat([pd.concat([weekly_ls_3_75_perc_pen] * 52, ignore_index=True), sat_ls_4_75_perc_pen], ignore_index=True)

# Downsample from minutely to hourly
annual_ls_1_75_perc_pen = downsample_minutely_to_hourly(annual_ls_1_75_perc_pen)
annual_ls_2_75_perc_pen = downsample_minutely_to_hourly(annual_ls_2_75_perc_pen)
annual_ls_3_75_perc_pen = downsample_minutely_to_hourly(annual_ls_3_75_perc_pen)
...
np.savetxt(f"processed_ev_schedule_data/75_perc/annual_ls_3.txt", annual_ls_3_75_perc_pen)
...
# Processing Weekly schedules (note- only taking first day of week for each of these so that can append them together in desired order)
mon_fri_ls_1_100_perc_pen  = process_ev_schedule_data('data/3 scenarios data/2hrs_ls/2hr_ls_mixed_fleet_all_percentages/76/m-f/ls_pattern=0.txt')
mon_fri_ls_2_100_perc_pen = process_ev_schedule_data('data/3 scenarios data/2hrs_ls/2hr_ls_mixed_fleet_all_percentages/76/m-f/ls_pattern=1.txt')
mon_fri_ls_3_100_perc_pen  = process_ev_schedule_data('data/3 scenarios data/2hrs_ls/2hr_ls_mixed_fleet_all_percentages/76/m-f/ls_pattern=2.txt')
mon_fri_ls_4_100_perc_pen  = process_ev_schedule_data('data/3 scenarios data/2hrs_ls/2hr_ls_mixed_fleet_all_percentages/76/m-f/ls_pattern=3.txt')
...
annual_ls_2_100_perc_pen = pd.concat([pd.concat([weekly_ls_2_100_perc_pen] * 52, ignore_index=True), sat_ls_2_100_perc_pen], ignore_index=True)
annual_ls_3_100_perc_pen = pd.concat([pd.concat([weekly_ls_3_100_perc_pen] * 52, ignore_index=True), sat_ls_4_100_perc_pen], ignore_index=True)

# Downsample from minutely to hourly
annual_ls_1_100_perc_pen = downsample_minutely_to_hourly(annual_ls_1_100_perc_pen)
annual_ls_2_100_perc_pen = downsample_minutely_to_hourly(annual_ls_2_100_perc_pen)
annual_ls_3_100_perc_pen = downsample_minutely_to_hourly(annual_ls_3_100_perc_pen)
...
np.savetxt(f"processed_ev_schedule_data/100_perc/annual_ls_3.txt", annual_ls_3_100_perc_pen)
...
# # Processing Weekly schedules
# mon_fri_ls_1_ev_only = process_ev_schedule_data('data/3 scenarios data/ls_only_ev_bigger_battery/m_f_0_ev=63_ice=0_ice_distance=0.txt')
# mon_fri_ls_2_ev_only= process_ev_schedule_data('data/3 scenarios data/ls_only_ev_bigger_battery/m_f_1_ev=51_ice=0_ice_distance=0.txt')
# mon_fri_ls_3_ev_only = process_ev_schedule_data('data/3 scenarios data/ls_only_ev_bigger_battery/m_f_2_ev=50_ice=0_ice_distance=0.txt')
# mon_fri_ls_4_ev_only = process_ev_schedule_data('data/3 scenarios data/ls_only_ev_bigger_battery/m_f_3_ev=53_ice=0_ice_distance=0.txt')
